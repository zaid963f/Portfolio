    ...
    <main className="min-h-screen bg-[var(--background)] px-5 pb-20 pt-32 sm:px-8 lg:px-12">
      <section className="mx-auto max-w-6xl">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-2">
          ...
          {/* Contact Info */}
          <FadeIn delay={0.1}>
            <div className="h-full rounded-3xl bg-[var(--nav-background)] p-8 sm:p-10">
              ...
              <FadeIn delay={0.15}>
                <a
                  href="mailto:mzfotaena@gmail.com"
          ...
          {/* Social Links */}
          <FadeIn delay={0.2}>
            <div className="h-full rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-8 sm:p-10">
