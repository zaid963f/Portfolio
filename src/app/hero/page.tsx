        ...
        <div className="order-2 max-w-2xl text-center lg:order-1 lg:text-left">
          ...
          <FadeIn delay={0.3}>
            <p className="mx-auto mt-5 max-w-xl text-base leading-7 text-[var(--text-muted)] sm:text-lg sm:leading-8 lg:mx-0">
              ...
              ideas and designs into functional digital experiences using
              React and Next.js, while keeping the code clean, maintainable,
              and well-structured. I care about both the visual details and
              the overall user experience, from responsive layouts to smooth
              interactions and thoughtful component architecture.
            </p>
          </FadeIn>
