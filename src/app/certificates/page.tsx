            ...
            {featuredCertificates.map((certificate, index) => (
              ...
              >
                <a
                  ...
                  className="group block overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--surface)] transition-all duration-300 hover:-translate-y-1 hover:border-[var(--primary)]/30 hover:shadow-[0_15px_40px_rgba(0,0,0,0.07)]"
                >
                  {/* Certificate Image */}
            ...
            {courseCertificates.map((certificate, index) => (
              ...
              >
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group block overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--surface)] transition-all duration-300 hover:-translate-y-1 hover:border-[var(--primary)]/30 hover:shadow-[0_12px_35px_rgba(0,0,0,0.06)]"
                >
                  {/* Image */}
                  <div className="relative aspect-[16/10] overflow-hidden bg-[var(--surface-muted)]">
                    <Image
        ...
        <FadeIn delay={0.15}>
          <div className="mt-16 border-t border-[var(--border)] pt-7">
            <p className="text-sm leading-6 text-[var(--text-light)]">
              Continuously learning and expanding my knowledge through
              practical projects and structured courses.
            </p>
          </div>
        </FadeIn>
